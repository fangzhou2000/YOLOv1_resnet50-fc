from dataset.data import VOC2007and2012Dataset, Compose, ToTensor, Resize
...
def test():
    ...
    dataset = VOC2007and2012Dataset(CFG.root, CFG.class_path, CFG.transforms, 'test',
    ...
    yolo_net = yolo(s=CFG.S, cell_out_ch=CFG.B*5 + CFG.num_classes, backbone_name=CFG.backbone_name)
    yolo_net.to(device)
